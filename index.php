...
<div id="wrapper">
     <!-- Navigation -->
     	...
     	<div class="col_3">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    $sqlvalues="SELECT * FROM users";
                    $value=mysqli_query($db,$sqlvalues); 
                    ?>
                      <h5><strong>Total Users</strong></h5>
                      <span><?php echo mysqli_num_rows($value); ?></span>
                    </div>
                </div>
        	</div>
        	<!-- 
	  ...
	  <br>
	  <div class="span_11" align="right">
		<div class="col-md-6 col_4" align="right">
		<div align="right">
		  <!----Calender -------->
