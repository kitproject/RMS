	     ...
	     <div class="xs">
  	       <h3>Forms</h3>
			   ...
			   <div class="tab-pane active" id="horizontal-form">
				 <form method="post" class="form-horizontal" action="project_modify.php">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Project Id : </label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="projid" placeholder="Project Id" required>
				   </div>
			   ...
			   <div class="tab-pane active" id="horizontal-form">
				 <form method="post" class="form-horizontal" action="project_modify.php">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="projid" placeholder="Project Name" required>
				   </div>
	  ...
	  <div class="panel-footer">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				...
				$sqlvalues="SELECT proj_id,proj_name FROM projects";
			    ...
			    <?php
				    ...
				    <tr>
				      ...
				      <td><a href="project_modify.php?projid=<?php echo $value['proj_id'] ?>">modify</a></td>
				     </tr>
				   <?php
					}
				?>
