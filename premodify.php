...
<div id="wrapper">
			   ...
			   <div class="tab-pane active" id="horizontal-form">
				 <form method="post" class="form-horizontal" action="modify.php">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="empid" placeholder="Employee Name" required>
				   </div>
	  ...
	  <div class="panel-footer">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				...
				$sqlvalues="SELECT emp_id,fname,lname FROM users";
			    ...
			    <?php
				    ...
				    <tr>
				      ...
				      <td><a href="modify.php?empid=<?php echo $value['emp_id'] ?>">modify</a></td>
				      <!--<td><a href="delete.php?empid=<?php echo $value['emp_id'] ?>" onclick="return confirm('Are You Sure?')">delete</a></td>-->
	...
	alert("in here")	;
		...
		if(confirm("Are you sure?")==true)
			{
				...
				location.href="delete.php?empid=<?php echo $value['emp_id'] ?>";
		...
		return ;
				      ...
				      <td><a href="delete.php?empid=<?php echo $value['emp_id'] ?>" onClick="return confirm_click()">delete</a></td>		        </tr>
				   <?php
					}
				?>
			      </tbody>
